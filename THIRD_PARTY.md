...
GPL-3.0-or-later. Keep the license, source, and modification patch with any
redistribution of the engine. WideMelon contains no Nintendo artwork or game
assets.
...
- melonDS: https://github.com/melonDS-emu/melonDS
  ...
  Local modifications: `patches/melonds-widemelon.patch`.
  Includes upstream bundled components; their license files remain in that tree.
...
- Qt 6, SDL2, libarchive, zstd, and other system libraries are linked using the
  host's development packages. Their respective licenses apply.
